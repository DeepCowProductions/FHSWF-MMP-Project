...
class GLItem : public QQuickItem
{
    ...
    Q_PROPERTY(bool movementActivated READ movementActivated WRITE setMovementActivated NOTIFY movementActivatedChanged)
...
public:
    explicit GLItem(QQuickItem *parent = 0,
                    ...
                    const QString &fragmentShaderFilename = ":/src/fshader.fsh");
    virtual ~GLItem();
...
signals:
    ...
    void movementActivatedChanged(bool arg);
...
public slots:
    ...
    /** Mouse event handlers. To be called from render thread
     **/
   ...
   void mouseReleased(int x, int y);
    ...
    void setMovementActivated (bool movementActivated);
...
protected slots:
    ...
    virtual void deleteExtraRenderers(){}
...
protected:
    ...
    QVector<GLuint> * indices(){return &m_indices;}
...
protected:
    ...
    double m_orthoRange; //range to be displayed
    bool m_drawAxes;
    ...
    int m_firstAxesIndex;
    int m_lastAxesIndex;
    /**
     * @brief timerTimeout perform time depending operations.
